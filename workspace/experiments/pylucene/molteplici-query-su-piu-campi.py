...
class MyPyLucene:
    ...
    def _execute_query(data: dict):
        ...
        # TODO: Implementare la ricerca su più campi
        # 1) Stampare e studiare la query in formato json restituita dal web server
        # 2) In base ai campi presenti nella query, creare i parser per i vari campi
        # 3) Combinare le query con un BooleanQuery
